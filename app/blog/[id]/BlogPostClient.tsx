...
export default function BlogPostClient({ params }: Props) {
  ...
  const relatedBlogs = getRelatedBlogs(params.id, 3);
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://sathishm.online/blog/${blog.id}`,
    },
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: 'Home',
        item: 'https://sathishm.online',
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: 'Blog',
        item: 'https://sathishm.online/blog',
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: blog.title,
        item: `https://sathishm.online/blog/${blog.id}`,
      },
    ],
  };
